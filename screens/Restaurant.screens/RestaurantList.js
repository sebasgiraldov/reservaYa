...
/**
 * Ventana para listar todos los Restaurantes
 */
  ...
  return (
    <ScrollView>
      <View style={{padding: 5}}>
        <Button title="Create Restaurant"
          onPress={() => props.navigation.navigate('CreateRestaurantScreen')} />
      </View>
      {
        restaurants.map(restaurant => {
          return (
            <ListItem
              key={restaurant.clave} bottomDivider onPress={() => {
                props.navigation.navigate('RestaurantDetailScreen', {
                  restaurantClave: restaurant.clave
                })
              }}>
              <ListItem.Chevron />
